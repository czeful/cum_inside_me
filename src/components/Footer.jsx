...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-blue-100 via-emerald-50 to-fuchsia-100 border-t border-blue-200 mt-12">
      <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col sm:flex-row justify-between items-center gap-8">
        ...
        <div className="flex flex-col items-center sm:items-start">
          ...
          <span className="text-gray-400 text-xs">
            Вдохновляйся. Достигай. Делись прогрессом.
          </span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-8">
          <div className="flex flex-col gap-1 items-center sm:items-end">
            <span className="font-semibold text-blue-900">Навигация</span>
          ...
          <div className="flex flex-col gap-1 items-center sm:items-end">
            <span className="font-semibold text-blue-900">О компании</span>
            <span className="text-sm text-gray-500">Контакты: support@achieve.com</span>
            <span className="text-sm text-gray-500">г. Астана, Казахстан</span>
            <span className="text-sm text-gray-400">Разработано с любовью ♥</span>
          </div>
        </div>
      </div>
    </footer>
