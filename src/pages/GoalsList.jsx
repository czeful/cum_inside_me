      ...
      <div className="max-w-2xl mx-auto mt-10">
        ...
        {goals.length === 0 ? (
          <div className="text-center text-gray-400 py-12">
            ...
            <Link to="/goals/new" className="text-blue-600 hover:underline">
            ...
            {goals.map((goal) => (
              <li key={goal.id || goal._id}>
                <Link
                  ...
                  className="block bg-white shadow-md hover:shadow-lg rounded-2xl p-5 border border-neutral-200 dark:border-neutral-800 transition group"
                >
                  <div className="flex items-center justify-between">
                    <span className="text-xl font-semibold group-hover:text-blue-600">
                      {goal.name}
                    </span>
                    {goal.category && (
