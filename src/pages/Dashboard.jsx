...
const Dashboard = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-emerald-50 to-fuchsia-100 relative overflow-x-hidden flex flex-col min-h-screen">
      <Navbar />
          ...
          <header className="mb-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <p className="text-lg text-gray-500 font-medium max-w-2xl">
                Welcome to the Goal Management System! <span className="text-emerald-600">Here you’ll find your motivation, your templates, and your achievements.</span>
              </p>
            </div>
          </header>
          ...
          <main>
            <section className="max-w-7xl mx-auto sm:px-6 lg:px-8">
              <div className="px-4 py-10 sm:px-0 rounded-3xl shadow-2xl bg-white/95 border border-blue-100">
                {/* Modern section title for templates */}
